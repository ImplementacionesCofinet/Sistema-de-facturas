      ...
      <form action={accion} className="space-y-4">
        ...
        <fieldset className="space-y-2">
          ...
          <label className="flex items-start gap-2 rounded-md border border-slate-200 p-3 text-sm">
            ...
            <span>
              <span className="font-medium text-slate-800">Importacion mensual (DIAN)</span>
          ...
          <label className="flex items-start gap-2 rounded-md border border-slate-200 p-3 text-sm">
            ...
            <span>
              <span className="font-medium text-slate-800">Carga inicial del Excel historico</span>
              <span className="block text-xs text-slate-500">
